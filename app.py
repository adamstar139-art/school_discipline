...
# Page Configuration - Set initial_sidebar_state to auto for seamless mobile experience
st.set_page_config(
...
<style>
    ...
    /* Prevent mobile iOS zoom on input focus & optimize touch targets */
    ...
    /* Responsive Media Queries for Mobile Screens (Mobile Phones & Tablets) */
...
def init_db():
    ...
    # Seed 167 Default Students unconditionally
    default_students = [
        # 1st Intermediate
...
# PAGE 1: Teacher Screen (Dynamic interactive UI without form blocking)
...
# PAGE 4: Student Management (Open Access - No Password Required)
